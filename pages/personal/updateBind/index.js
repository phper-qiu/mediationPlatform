...
Page({
  ...
  formSubmit: function(e) {
    ...
    let that = this;
    util.request(api.modifyPhone, { uid: wx.getStorageSync('uid'),newPhone: that.data.phone ,verifyCode: e.detail.value.verifyCode,},'POST').then(function (res) {
      console.log(res)
      if (res.code == 200) {
        that.setData({
          // getVerifyCode: res.data
      ...
      var url = '/pages/personal/index/index';
      wx.switchTab({
        url: url
      })
    });
